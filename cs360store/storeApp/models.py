...
class Vendor(models.Model):
    ...
    phone_number = models.IntegerField(max_length=20, help_text="1 (234) 567 8901")
    emergency_phone_number = models.IntegerField(max_length=20, help_text="1 (234) 567 8901")

    business_address = models.ForeignKey(Address)
...
class ProductListing(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Enter a name for your product (this cannot be changed later)", editable=False)
    ...
    quantityAvailable = models.IntegerField(max_digits=10, help_text="How many are available? Leave blank if unlimited.", null=True, blank=True)
...
class ServiceListing(models.Model):
    ...
    active = models.BooleanField(default=True)
    name = models.CharField(max_length=200, help_text="Enter a name for your service (this cannot be changed later)", editable=False)
    ...
    daysAvailable = models.CharField(max_length=200, help_text="Enter the days/times this service is available, i.e. M-Th 9-5, Fri-Sun 10-1", null=True, blank=True)
...
class ServiceTag(models.Model):
    ...
    name = models.CharField(max_length=200, help_text="Enter a tag; i.e. \"electronics\"", primary_key=True, unique=True)
    product = models.ManyToManyField(ServiceListing)
